...
<body <?php body_class(); ?>>
    ...
    <header>
        <nav class="navbar navbar-expand-lg">
            <div class="container container-for-mobile-adjust">
                <!-- Brand -->
                ...
                <div class="show-on-mobile mobile-section">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="contact-info">
                        ...
                        <button class="btn submit-cv-btn"><?php echo esc_html(get_theme_mod('submit_cv_button_text', 'Submit Your CV')); ?></button>
                        <button id="themeToggle" class="btn ms-2 themeToggle">
    ...
    <button id="themeToggle-mobile" class="btn ms-2 themeToggle hidden-desktop">
        <i class="fas fa-moon"></i>
    </button>