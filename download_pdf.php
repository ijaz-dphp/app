...
// Set margins - reduce bottom margin to prevent early page break
...
$pdf->SetY(26); // Start after logo (logo ends at Y=25)
...
// Comments Section - Comments and text on same line
...
$bottomMargin = 15;
$footerHeight = 20; // Reduced space needed for footer

// Only move to bottom if there's enough space, otherwise let it flow naturally
...
$pdf->SetFont('helvetica', '', 9);
$pdf->Cell(0, 4, $report['verified_by'] ?? 'Dr.Farheen Aslam - N/A', 0, 1, 'R');
